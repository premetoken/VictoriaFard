...
export const StyledButton = styled.button`
  ...
  width: 100px;
  cursor: pointer;
  box-shadow: 2px 4px 0px -2px rgba(115, 60, 88, 0.5);
  -webkit-box-shadow: 2px 4px 0px -2px rgba(115, 60, 88, 0.5);
  -moz-box-shadow: 2px 4px 0px -2px rgba(115, 60, 88, 0.5);
  :active {
    box-shadow: none;
...
function App() {
  ...
  const claimNFTs = () => {
    ...
    setFeedback(`Minting your Victoria Fard NFT...`);
    setClaimingNft(true);
